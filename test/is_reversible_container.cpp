...
{
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_reversible_container<
            std::vector<int>
        >
    ));
    BOOST_MPL_ASSERT((
    ...
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_reversible_container<std::deque<int> >
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_reversible_container<std::deque<int> const>
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_reversible_container<std::list<int> >
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_reversible_container<std::list<int> const>
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_reversible_container<std::set<int> >
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_reversible_container<std::set<int> const>
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_reversible_container<std::map<int,int> >
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_reversible_container<
...
//[test__is_reversible_container__ublas
MPL_TEST_CASE()
{
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_reversible_container<
