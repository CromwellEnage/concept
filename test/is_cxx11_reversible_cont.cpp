...
#include <boost/concept/traits/query/is_cxx11_reversible_cont.hpp>
...
{
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_cxx11_reversible_container<
            std::vector<int>
        >
    ));
    BOOST_MPL_ASSERT((
...
//[test__is_cxx11_reversible_container__ublas
MPL_TEST_CASE()
{
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_cxx11_reversible_container<
