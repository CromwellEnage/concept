...
MPL_TEST_CASE()
{
    BOOST_MPL_ASSERT_NOT((
        boost::concept::traits::is_multiple_simple_associative_ptr_container<
            std::vector<int>
        >
    ));
    BOOST_MPL_ASSERT_NOT((
...
//[test__is_multiple_simple_associative_ptr_container__ublas
MPL_TEST_CASE()
{
    BOOST_MPL_ASSERT_NOT((
        boost::concept::traits::is_multiple_simple_associative_ptr_container<
...
MPL_TEST_CASE()
{
    ...
    BOOST_MPL_ASSERT_NOT((
        boost::concept::traits::is_multiple_simple_associative_ptr_container<boost::heap::pairing_heap<int> >
    ));
    BOOST_MPL_ASSERT_NOT((
        boost::concept::traits::is_multiple_simple_associative_ptr_container<
    ...
    BOOST_MPL_ASSERT_NOT((
        boost::concept::traits::is_multiple_simple_associative_ptr_container<boost::heap::skew_heap<int> >
    ));
    BOOST_MPL_ASSERT_NOT((
        boost::concept::traits::is_multiple_simple_associative_ptr_container<
