...
{
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_nullable_pointer<int*>
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_nullable_pointer<int const*>
    ));
    BOOST_MPL_ASSERT_NOT((
        boost::concept::traits::is_nullable_pointer<boost::optional<int> >
    ));
    BOOST_MPL_ASSERT_NOT((
        boost::concept::traits::is_nullable_pointer<boost::weak_ptr<int> >
    ));
    BOOST_MPL_ASSERT_NOT((
        boost::concept::traits::is_nullable_pointer<boost::scoped_ptr<int> >
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_nullable_pointer<boost::shared_ptr<int> >
    ));
    BOOST_MPL_ASSERT_NOT((
        boost::concept::traits::is_nullable_pointer<boost::scoped_array<int> >
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_nullable_pointer<boost::shared_array<int> >
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_nullable_pointer<
...
//[test__is_nullable_pointer__ublas_vector_iterators
MPL_TEST_CASE()
{
    BOOST_MPL_ASSERT_NOT((
        boost::concept::traits::is_nullable_pointer<
...
//[test__is_nullable_pointer__ublas_matrix_iterators
MPL_TEST_CASE()
{
    BOOST_MPL_ASSERT_NOT((
        boost::concept::traits::is_nullable_pointer<
...
//[test__is_nullable_pointer__ublas_storage_iterators
MPL_TEST_CASE()
{
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_nullable_pointer<
