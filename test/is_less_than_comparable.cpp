...
{
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_less_than_comparable<signed char>
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_less_than_comparable<signed char const>
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_less_than_comparable<unsigned char>
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_less_than_comparable<unsigned char const>
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_less_than_comparable<signed short>
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_less_than_comparable<signed short const>
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_less_than_comparable<unsigned short>
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_less_than_comparable<unsigned short const>
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_less_than_comparable<signed int>
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_less_than_comparable<signed int const>
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_less_than_comparable<unsigned int>
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_less_than_comparable<unsigned int const>
    ));
    //...
    //<-
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_less_than_comparable<signed long>
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_less_than_comparable<signed long const>
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_less_than_comparable<unsigned long>
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_less_than_comparable<unsigned long const>
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_less_than_comparable<float>
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_less_than_comparable<float const>
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_less_than_comparable<double>
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_less_than_comparable<double const>
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_less_than_comparable<long double>
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_less_than_comparable<long double const>
    ));
    //->
}
//]
...
{
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_less_than_comparable<test::minimal>
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_less_than_comparable<test::minimal const>
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_less_than_comparable<
...
{
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_less_than_comparable<int*>
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_less_than_comparable<int const*>
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_less_than_comparable<boost::optional<int> >
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_less_than_comparable<boost::weak_ptr<int> >
    ));
    BOOST_MPL_ASSERT_NOT((
        boost::concept::traits::is_less_than_comparable<
