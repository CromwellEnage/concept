...
MPL_TEST_CASE()
{
    BOOST_MPL_ASSERT_NOT((
        boost::concept::traits::has_element_type<int*>
    ));
    BOOST_MPL_ASSERT_NOT((
        boost::concept::traits::has_element_type<boost::optional<int> >
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::has_element_type<boost::weak_ptr<int> >
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::has_element_type<boost::scoped_ptr<int> >
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::has_element_type<boost::shared_ptr<int> >
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::has_element_type<boost::scoped_array<int> >
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::has_element_type<boost::shared_array<int> >
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::has_element_type<boost::intrusive_ptr<int> >
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::has_element_type<
//<-
#if defined BOOST_NO_CXX11_DECLTYPE
...
//[test__has_element_type__std_container_iterators
MPL_TEST_CASE()
{
    BOOST_MPL_ASSERT_NOT((
        boost::concept::traits::has_element_type<
...
//[test__has_element_type__ublas_vector_iterators
MPL_TEST_CASE()
{
    BOOST_MPL_ASSERT_NOT((
        boost::concept::traits::has_element_type<
...
//[test__has_element_type__ublas_matrix_iterators
MPL_TEST_CASE()
{
    BOOST_MPL_ASSERT_NOT((
        boost::concept::traits::has_element_type<
...
//[test__has_element_type__ublas_storage_iterators
MPL_TEST_CASE()
{
    BOOST_MPL_ASSERT_NOT((
        boost::concept::traits::has_element_type<
