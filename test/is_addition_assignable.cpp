...
//[test__is_addition_assignable__builtin
MPL_TEST_CASE()
{
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_addition_assignable<signed char>
    ));
    BOOST_MPL_ASSERT_NOT((
        boost::concept::traits::is_addition_assignable<signed char const>
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_addition_assignable<unsigned char>
    ));
    BOOST_MPL_ASSERT_NOT((
        boost::concept::traits::is_addition_assignable<unsigned char const>
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_addition_assignable<signed short>
    ));
    BOOST_MPL_ASSERT_NOT((
        boost::concept::traits::is_addition_assignable<signed short const>
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_addition_assignable<unsigned short>
    ));
    BOOST_MPL_ASSERT_NOT((
        boost::concept::traits::is_addition_assignable<unsigned short const>
    ));
    //...
    //<-
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_addition_assignable<signed int>
    ));
    BOOST_MPL_ASSERT_NOT((
        boost::concept::traits::is_addition_assignable<signed int const>
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_addition_assignable<unsigned int>
    ));
    BOOST_MPL_ASSERT_NOT((
        boost::concept::traits::is_addition_assignable<unsigned int const>
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_addition_assignable<signed long>
    ));
    BOOST_MPL_ASSERT_NOT((
        boost::concept::traits::is_addition_assignable<signed long const>
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_addition_assignable<unsigned long>
    ));
    BOOST_MPL_ASSERT_NOT((
        boost::concept::traits::is_addition_assignable<unsigned long const>
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_addition_assignable<float>
    ));
    BOOST_MPL_ASSERT_NOT((
        boost::concept::traits::is_addition_assignable<float const>
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_addition_assignable<double>
    ));
    BOOST_MPL_ASSERT_NOT((
        boost::concept::traits::is_addition_assignable<double const>
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_addition_assignable<long double>
    ));
    BOOST_MPL_ASSERT_NOT((
        boost::concept::traits::is_addition_assignable<long double const>
    ));
    //->
}
//]
...
//[test__is_addition_assignable__multiprecision
MPL_TEST_CASE()
{
    BOOST_MPL_ASSERT((
...
//[test__is_addition_assignable__minimal
namespace test {
    ...
    minimal2& operator+=(minimal2&, addend const&);
}
...
//[test__is_addition_assignable__archetypes
MPL_TEST_CASE()
{
    //...
    //<-
...
//[test__is_addition_assignable__std_iterators
MPL_TEST_CASE()
{
    BOOST_MPL_ASSERT_NOT((
        boost::concept::traits::is_addition_assignable<
...
//[test__is_addition_assignable__ublas_vectors
MPL_TEST_CASE()
{
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_addition_assignable<
...
//[test__is_addition_assignable__ublas_matrices
MPL_TEST_CASE()
{
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_addition_assignable<
...
//[test__is_addition_assignable__ublas_storage
MPL_TEST_CASE()
{
    BOOST_MPL_ASSERT_NOT((
        boost::concept::traits::is_addition_assignable<
...
//[test__is_addition_assignable__other
MPL_TEST_CASE()
{
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_addition_assignable<
