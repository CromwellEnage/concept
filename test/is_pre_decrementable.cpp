...
{
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_pre_decrementable<signed char>
    ));
    BOOST_MPL_ASSERT_NOT((
        boost::concept::traits::is_pre_decrementable<signed char const>
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_pre_decrementable<unsigned char>
    ));
    BOOST_MPL_ASSERT_NOT((
        boost::concept::traits::is_pre_decrementable<unsigned char const>
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_pre_decrementable<signed short>
    ));
    BOOST_MPL_ASSERT_NOT((
        boost::concept::traits::is_pre_decrementable<signed short const>
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_pre_decrementable<unsigned short>
    ));
    BOOST_MPL_ASSERT_NOT((
        boost::concept::traits::is_pre_decrementable<unsigned short const>
    ));
    //...
    //<-
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_pre_decrementable<signed int>
    ));
    BOOST_MPL_ASSERT_NOT((
        boost::concept::traits::is_pre_decrementable<signed int const>
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_pre_decrementable<unsigned int>
    ));
    BOOST_MPL_ASSERT_NOT((
        boost::concept::traits::is_pre_decrementable<unsigned int const>
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_pre_decrementable<signed long>
    ));
    BOOST_MPL_ASSERT_NOT((
        boost::concept::traits::is_pre_decrementable<signed long const>
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_pre_decrementable<unsigned long>
    ));
    BOOST_MPL_ASSERT_NOT((
        boost::concept::traits::is_pre_decrementable<unsigned long const>
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_pre_decrementable<float>
    ));
    BOOST_MPL_ASSERT_NOT((
        boost::concept::traits::is_pre_decrementable<float const>
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_pre_decrementable<double>
    ));
    BOOST_MPL_ASSERT_NOT((
        boost::concept::traits::is_pre_decrementable<double const>
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_pre_decrementable<long double>
    ));
    BOOST_MPL_ASSERT_NOT((
        boost::concept::traits::is_pre_decrementable<long double const>
    ));
    //->
}
//]
...
{
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_pre_decrementable<
...
{
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_pre_decrementable<test::minimal>
    ));
    BOOST_MPL_ASSERT_NOT((
        boost::concept::traits::is_pre_decrementable<test::minimal const>
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_pre_decrementable<
    ...
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_pre_decrementable<test::okay>
    ));
    BOOST_MPL_ASSERT_NOT((
        boost::concept::traits::is_pre_decrementable<test::okay const>
    ));
    BOOST_MPL_ASSERT_NOT((
        boost::concept::traits::is_pre_decrementable<test::failure>
    ));
    BOOST_MPL_ASSERT_NOT((
        boost::concept::traits::is_pre_decrementable<test::failure const>
    ));
}
//]
