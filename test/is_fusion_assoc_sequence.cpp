...
MPL_TEST_CASE()
{
    BOOST_MPL_ASSERT_NOT((
        boost::concept::traits::is_fusion_associative_sequence<
            std::vector<int>
        >
    ));
    BOOST_MPL_ASSERT_NOT((
...
MPL_TEST_CASE()
{
    ...
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_fusion_associative_sequence<
            boost::fusion::joint_view<
                boost::fusion::map<boost::fusion::pair<int,int> >
              , boost::fusion::map<boost::fusion::pair<char,char> >
            >
        >
    ));
    BOOST_MPL_ASSERT((
...
#if !defined BOOST_CONCEPT_CONFIG_BUG_CONST_INCORRECT_FUSION_SINGLE_VIEW
    BOOST_MPL_ASSERT_NOT((
        boost::concept::traits::is_fusion_associative_sequence<
            boost::fusion::transform_view<
                boost::fusion::vector<int>
...
//<-
#if !defined BOOST_CONCEPT_CONFIG_BUG_IN_FUSION_REVERSE_VIEW_OF_MAP
//->
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_fusion_associative_sequence<
