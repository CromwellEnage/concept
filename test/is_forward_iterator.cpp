...
{
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_forward_iterator<int*>
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_forward_iterator<int const*>
    ));
    BOOST_MPL_ASSERT_NOT((
        boost::concept::traits::is_forward_iterator<boost::optional<int> >
    ));
    BOOST_MPL_ASSERT_NOT((
        boost::concept::traits::is_forward_iterator<boost::weak_ptr<int> >
    ));
    BOOST_MPL_ASSERT_NOT((
        boost::concept::traits::is_forward_iterator<boost::scoped_ptr<int> >
    ));
    BOOST_MPL_ASSERT_NOT((
        boost::concept::traits::is_forward_iterator<boost::shared_ptr<int> >
    ));
    BOOST_MPL_ASSERT_NOT((
        boost::concept::traits::is_forward_iterator<boost::scoped_array<int> >
    ));
    BOOST_MPL_ASSERT_NOT((
        boost::concept::traits::is_forward_iterator<boost::shared_array<int> >
    ));
    BOOST_MPL_ASSERT_NOT((
