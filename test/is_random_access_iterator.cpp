...
{
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_random_access_iterator<int*>
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_random_access_iterator<int const*>
    ));
...
#endif
            ((
                boost::const_begin(std::list<int>() | boost::adaptors::uniqued)
            ))
        >
    ));
    BOOST_MPL_ASSERT_NOT((
