...
MPL_TEST_CASE()
{
    BOOST_MPL_ASSERT_NOT((
        boost::concept::traits::is_mpl_boolean_constant<bool>
    ));
    BOOST_MPL_ASSERT_NOT((
    ...
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_mpl_boolean_constant<boost::mpl::true_>
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_mpl_boolean_constant<boost::mpl::false_>
    ));
    BOOST_MPL_ASSERT_NOT((
        boost::concept::traits::is_mpl_boolean_constant<
            boost::mpl::char_<' '>
    ...
    BOOST_MPL_ASSERT_NOT((
        boost::concept::traits::is_mpl_boolean_constant<boost::mpl::int_<1> >
    ));
    BOOST_MPL_ASSERT_NOT((
        boost::concept::traits::is_mpl_boolean_constant<boost::mpl::long_<1> >
    ));
    BOOST_MPL_ASSERT_NOT((
        boost::concept::traits::is_mpl_boolean_constant<
            boost::mpl::size_t<1>
...
{
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_mpl_boolean_constant<boost::true_type>
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_mpl_boolean_constant<boost::false_type>
    ));
    //...
    //<-
    BOOST_MPL_ASSERT((
...
{
    BOOST_MPL_ASSERT_NOT((
        boost::concept::traits::is_mpl_boolean_constant<std::true_type>
    ));
    BOOST_MPL_ASSERT_NOT((
        boost::concept::traits::is_mpl_boolean_constant<std::false_type>
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_mpl_boolean_constant<
    ...
    BOOST_MPL_ASSERT_NOT((
        boost::concept::traits::is_mpl_boolean_constant<std::is_object<int> >
    ));
    BOOST_MPL_ASSERT_NOT((
        boost::concept::traits::is_mpl_boolean_constant<std::is_object<void> >
    ));
    BOOST_MPL_ASSERT_NOT((
        boost::concept::traits::is_mpl_boolean_constant<std::is_pod<baz> >
    ));
    BOOST_MPL_ASSERT_NOT((
        boost::concept::traits::is_mpl_boolean_constant<std::is_pod<void> >
    ));
    BOOST_MPL_ASSERT_NOT((
        boost::concept::traits::is_mpl_boolean_constant<
            std::is_pointer<char*>
