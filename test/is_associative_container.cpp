...
MPL_TEST_CASE()
{
    BOOST_MPL_ASSERT_NOT((
        boost::concept::traits::is_associative_container<
            std::vector<int>
        >
    ));
    BOOST_MPL_ASSERT_NOT((
    ...
    BOOST_MPL_ASSERT_NOT((
        boost::concept::traits::is_associative_container<std::list<int> >
    ));
    BOOST_MPL_ASSERT_NOT((
        boost::concept::traits::is_associative_container<std::list<int> const>
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_associative_container<std::set<int> >
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_associative_container<std::set<int> const>
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_associative_container<std::map<int,int> >
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_associative_container<
...
//[test__is_associative_container__ublas
MPL_TEST_CASE()
{
    //...
    //<-
