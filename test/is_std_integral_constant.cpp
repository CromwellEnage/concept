...
MPL_TEST_CASE()
{
    BOOST_MPL_ASSERT_NOT((
        boost::concept::traits::is_std_integral_constant<int>
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_std_integral_constant<
            boost::mpl::integral_c<short,1>
        >
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_std_integral_constant<boost::mpl::true_>
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_std_integral_constant<boost::mpl::false_>
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_std_integral_constant<
            boost::mpl::char_<' '>
...
{
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_std_integral_constant<boost::true_type>
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_std_integral_constant<boost::false_type>
    ));
    //...
    //<-
    BOOST_MPL_ASSERT((
...
{
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_std_integral_constant<std::true_type>
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_std_integral_constant<std::false_type>
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_std_integral_constant<
