...
{
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_lvalue_property_map<double*>
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_lvalue_property_map<double* const>
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_lvalue_property_map<int const*>
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_lvalue_property_map<int const* const>
    ));
    BOOST_MPL_ASSERT_NOT((
        boost::concept::traits::is_lvalue_property_map<
