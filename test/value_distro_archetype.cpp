...
#include <boost/concept/archetype/value_distribution.hpp>
...
//[test__value_distribution_archetype
MPL_TEST_CASE()
{
    BOOST_MPL_ASSERT_NOT((
        boost::concept::traits::is_value_generator<
            boost::concept::value_distribution_archetype<double>
        >
    ));
    BOOST_MPL_ASSERT((
...
#endif
//->
            (&boost::concept::value_distribution_archetype<double>::min)()
        >
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_callable<
...
#endif
//->
            (&boost::concept::value_distribution_archetype<double>::max)()
        >
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_callable<
...
#endif
//->
            (&boost::concept::value_distribution_archetype<double>::reset)()
        >
    ));
    BOOST_MPL_ASSERT_NOT((
...
//->
                (
                    &boost::concept::value_distribution_archetype<
                        double
                    >::reset
                )()
            >::type
