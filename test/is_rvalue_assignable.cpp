...
{
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_rvalue_assignable<signed char>
    ));
    BOOST_MPL_ASSERT_NOT((
        boost::concept::traits::is_rvalue_assignable<signed char const>
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_rvalue_assignable<unsigned char>
    ));
    BOOST_MPL_ASSERT_NOT((
        boost::concept::traits::is_rvalue_assignable<unsigned char const>
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_rvalue_assignable<signed short>
    ));
    BOOST_MPL_ASSERT_NOT((
        boost::concept::traits::is_rvalue_assignable<signed short const>
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_rvalue_assignable<unsigned short>
    ));
    BOOST_MPL_ASSERT_NOT((
        boost::concept::traits::is_rvalue_assignable<unsigned short const>
    ));
    //...
    //<-
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_rvalue_assignable<signed int>
    ));
    BOOST_MPL_ASSERT_NOT((
        boost::concept::traits::is_rvalue_assignable<signed int const>
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_rvalue_assignable<unsigned int>
    ));
    BOOST_MPL_ASSERT_NOT((
        boost::concept::traits::is_rvalue_assignable<unsigned int const>
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_rvalue_assignable<signed long>
    ));
    BOOST_MPL_ASSERT_NOT((
        boost::concept::traits::is_rvalue_assignable<signed long const>
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_rvalue_assignable<unsigned long>
    ));
    BOOST_MPL_ASSERT_NOT((
        boost::concept::traits::is_rvalue_assignable<unsigned long const>
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_rvalue_assignable<float>
    ));
    BOOST_MPL_ASSERT_NOT((
        boost::concept::traits::is_rvalue_assignable<float const>
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_rvalue_assignable<double>
    ));
    BOOST_MPL_ASSERT_NOT((
        boost::concept::traits::is_rvalue_assignable<double const>
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_rvalue_assignable<long double>
    ));
    BOOST_MPL_ASSERT_NOT((
        boost::concept::traits::is_rvalue_assignable<long double const>
    ));
    //->
}
//]
...
{
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_rvalue_assignable<
...
namespace test {
    ...
    struct move_but_not_copy_assignable
    {
        boost::noncopyable unused;
        move_but_not_copy_assignable&
            operator=(BOOST_RV_REF(move_but_not_copy_assignable));
    };

    struct not_assignable_archetype_move_assignable
    {
        boost::noncopyable unused;
        not_assignable_archetype_move_assignable&
...
MPL_TEST_CASE()
{
    ...
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_rvalue_assignable<
            test::move_but_not_copy_assignable
        >
    ));
    BOOST_MPL_ASSERT_NOT((
        boost::concept::traits::is_rvalue_assignable<
            test::move_but_not_copy_assignable const
        >
    ));
    BOOST_MPL_ASSERT_NOT((
        boost::concept::traits::is_rvalue_assignable<
            test::not_assignable_archetype_move_assignable
        >
    ));
    BOOST_MPL_ASSERT_NOT((
        boost::concept::traits::is_rvalue_assignable<
    ...
    BOOST_MPL_ASSERT_NOT((
        boost::concept::traits::is_rvalue_assignable<test::unassignable>
    ));
}
//]
