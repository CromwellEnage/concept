...
{
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_adjacency_graph<
...
{
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_adjacency_graph<boost::grid_graph<5> >
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_adjacency_graph<boost::grid_graph<5> const>
    ));
