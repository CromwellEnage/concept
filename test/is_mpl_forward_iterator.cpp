...
MPL_TEST_CASE()
{
    BOOST_MPL_ASSERT_NOT((
        boost::concept::traits::is_mpl_forward_iterator<
...
MPL_TEST_CASE()
{
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_mpl_forward_iterator<
            boost::mpl::begin<std::pair<int,int> >::type
        >
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_mpl_forward_iterator<
            boost::mpl::begin<std::pair<int,int> const>::type
        >
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_mpl_forward_iterator<
...
MPL_TEST_CASE()
{
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_mpl_forward_iterator<
            boost::mpl::begin<boost::array<int,1> >::type
        >
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_mpl_forward_iterator<
            boost::mpl::begin<boost::array<int,1> const>::type
        >
    ));
}
#endif
...
MPL_TEST_CASE()
{
    ...
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_mpl_forward_iterator<
            boost::mpl::begin<boost::mpl::empty_sequence const>::type
        >
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_mpl_forward_iterator<
            boost::mpl::begin<boost::mpl::single_view<int> >::type
        >
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_mpl_forward_iterator<
            boost::mpl::begin<boost::mpl::single_view<int> const>::type
        >
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_mpl_forward_iterator<
...
MPL_TEST_CASE()
{
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_mpl_forward_iterator<
            boost::mpl::begin<boost::tuples::tuple<char&,short&,int&> >::type
        >
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_mpl_forward_iterator<
    ...
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_mpl_forward_iterator<
            boost::mpl::begin<boost::fusion::vector<int> >::type
        >
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_mpl_forward_iterator<
            boost::mpl::begin<boost::fusion::vector<int> const>::type
        >
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_mpl_forward_iterator<
            boost::mpl::begin<boost::fusion::deque<int> >::type
        >
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_mpl_forward_iterator<
            boost::mpl::begin<boost::fusion::deque<int> const>::type
        >
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_mpl_forward_iterator<
            boost::mpl::begin<boost::fusion::nil>::type
        >
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_mpl_forward_iterator<
            boost::mpl::begin<boost::fusion::nil const>::type
        >
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_mpl_forward_iterator<
            boost::mpl::begin<boost::fusion::cons<int> >::type
        >
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_mpl_forward_iterator<
            boost::mpl::begin<boost::fusion::cons<int> const>::type
        >
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_mpl_forward_iterator<
            boost::mpl::begin<boost::fusion::list<int> >::type
        >
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_mpl_forward_iterator<
            boost::mpl::begin<boost::fusion::list<int> const>::type
        >
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_mpl_forward_iterator<
            boost::mpl::begin<boost::fusion::set<int> >::type
        >
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_mpl_forward_iterator<
            boost::mpl::begin<boost::fusion::set<int> const>::type
        >
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_mpl_forward_iterator<
...
MPL_TEST_CASE()
{
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_mpl_forward_iterator<
            boost::mpl::begin<boost::fusion::single_view<int> >::type
        >
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_mpl_forward_iterator<
            boost::mpl::begin<boost::fusion::single_view<int> const>::type
        >
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_mpl_forward_iterator<
