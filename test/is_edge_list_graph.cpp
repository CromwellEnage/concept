...
{
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_edge_list_graph<
...
{
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_edge_list_graph<boost::grid_graph<5> >
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_edge_list_graph<boost::grid_graph<5> const>
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_edge_list_graph<
