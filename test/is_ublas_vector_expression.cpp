...
MPL_TEST_CASE()
{
    BOOST_MPL_ASSERT_NOT((
        boost::concept::traits::is_ublas_vector_expression<
            std::vector<int>
        >
    ));
    BOOST_MPL_ASSERT_NOT((
...
//[test__is_ublas_vector_expression__ublas_vectors
MPL_TEST_CASE()
{
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_ublas_vector_expression<
...
//[test__is_ublas_vector_expression__ublas_matrices
MPL_TEST_CASE()
{
    BOOST_MPL_ASSERT_NOT((
        boost::concept::traits::is_ublas_vector_expression<
...
//[test__is_ublas_vector_expression__ublas_storage
MPL_TEST_CASE()
{
    BOOST_MPL_ASSERT_NOT((
        boost::concept::traits::is_ublas_vector_expression<
