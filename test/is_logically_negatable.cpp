...
{
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_logically_negatable<signed char>
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_logically_negatable<signed char const>
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_logically_negatable<unsigned char>
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_logically_negatable<unsigned char const>
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_logically_negatable<signed short>
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_logically_negatable<signed short const>
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_logically_negatable<unsigned short>
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_logically_negatable<unsigned short const>
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_logically_negatable<signed int>
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_logically_negatable<signed int const>
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_logically_negatable<unsigned int>
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_logically_negatable<unsigned int const>
    ));
    //...
    //<-
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_logically_negatable<signed long>
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_logically_negatable<signed long const>
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_logically_negatable<unsigned long>
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_logically_negatable<unsigned long const>
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_logically_negatable<float>
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_logically_negatable<float const>
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_logically_negatable<double>
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_logically_negatable<double const>
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_logically_negatable<long double>
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_logically_negatable<long double const>
    ));
    //->
}
//]
...
{
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_logically_negatable<
...
namespace test {
    ...
    bool operator!(incorrect_2&);

    struct incorrect_3
    {
        incorrect_3 operator!() const;
    };
}
...
{
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_logically_negatable<test::minimal_1>
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_logically_negatable<test::minimal_2>
    ));
    BOOST_MPL_ASSERT_NOT((
        boost::concept::traits::is_logically_negatable<test::incorrect_1>
    ));
    BOOST_MPL_ASSERT_NOT((
        boost::concept::traits::is_logically_negatable<test::incorrect_2>
    ));
    BOOST_MPL_ASSERT_NOT((
        boost::concept::traits::is_logically_negatable<test::incorrect_3>
    ));
}
//]
...
{
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_logically_negatable<int*>
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_logically_negatable<int const*>
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_logically_negatable<
            boost::optional<int>
