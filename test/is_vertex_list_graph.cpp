...
{
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_vertex_list_graph<
            boost::adjacency_list<>
        >
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_vertex_list_graph<
            boost::adjacency_list<> const
        >
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_vertex_list_graph<
...
{
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_vertex_list_graph<boost::grid_graph<5> >
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_vertex_list_graph<boost::grid_graph<5> const>
    ));
