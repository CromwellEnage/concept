...
{
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_stack_or_std_heap<std::stack<int> >
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_stack_or_std_heap<std::stack<int> const>
    ));
    BOOST_MPL_ASSERT_NOT((
        boost::concept::traits::is_stack_or_std_heap<std::queue<int> >
    ));
    BOOST_MPL_ASSERT_NOT((
        boost::concept::traits::is_stack_or_std_heap<std::queue<int> const>
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_stack_or_std_heap<
            std::priority_queue<int>
        >
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_stack_or_std_heap<
            std::priority_queue<int> const
        >
    ));
    //<-
    BOOST_MPL_ASSERT((
    ...
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_stack_or_std_heap<
            boost::queue<int> const
        >
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_stack_or_std_heap<
            boost::mutable_queue<int>
        >
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_stack_or_std_heap<
            boost::mutable_queue<int> const
        >
    ));
    //->
}
