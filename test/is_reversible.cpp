...
//[test__is_reversible__std_containers
MPL_TEST_CASE()
{
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_reversible<std::vector<int> >
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_reversible<std::vector<int> const>
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_reversible<std::deque<int> >
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_reversible<std::deque<int> const>
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_reversible<std::list<int> >
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_reversible<std::list<int> const>
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_reversible<std::set<int> >
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_reversible<std::set<int> const>
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_reversible<std::map<int,int> >
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_reversible<std::map<int,int> const>
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_reversible<std::multiset<int> >
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_reversible<std::multiset<int> const>
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_reversible<std::multimap<int,int> >
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_reversible<std::multimap<int,int> const>
    ));
}
//]
...
//[test__is_reversible__boost_containers
MPL_TEST_CASE()
{
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_reversible<
...
{
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_reversible<std::array<int,1> >
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_reversible<std::array<int,1> const>
    ));
}
#endif
...
{
    BOOST_MPL_ASSERT_NOT((
        boost::concept::traits::is_reversible<std::forward_list<int> >
    ));
    BOOST_MPL_ASSERT_NOT((
        boost::concept::traits::is_reversible<std::forward_list<int> const>
    ));
}
#endif
...
{
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_reversible<std::tr1::array<int,1> >
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_reversible<std::tr1::array<int,1> const>
    ));
}
#endif
...
{
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_reversible<boost::array<int,1> >
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_reversible<boost::array<int,1> const>
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_reversible<boost::ptr_array<int,1> >
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_reversible<boost::ptr_array<int,1> const>
    ));
}
...
//[test__is_reversible__ptr_containers
MPL_TEST_CASE()
{
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_reversible<
...
//[test__is_reversible__multi_index_containers
MPL_TEST_CASE()
{
...
//[test__is_reversible__bimap_views
MPL_TEST_CASE()
{
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_reversible<
...
//[test__is_reversible__boost_heaps
MPL_TEST_CASE()
{
    BOOST_MPL_ASSERT_NOT((
        boost::concept::traits::is_reversible<
...
//[test__is_reversible__misc_containers
MPL_TEST_CASE()
{
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_reversible<
