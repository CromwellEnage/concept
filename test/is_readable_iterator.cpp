...
{
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_readable_iterator<int*>
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_readable_iterator<int const*>
    ));
    BOOST_MPL_ASSERT_NOT((
        boost::concept::traits::is_readable_iterator<boost::optional<int> >
    ));
    BOOST_MPL_ASSERT_NOT((
        boost::concept::traits::is_readable_iterator<boost::weak_ptr<int> >
    ));
    BOOST_MPL_ASSERT_NOT((
        boost::concept::traits::is_readable_iterator<boost::scoped_ptr<int> >
    ));
    BOOST_MPL_ASSERT_NOT((
        boost::concept::traits::is_readable_iterator<boost::shared_ptr<int> >
    ));
    BOOST_MPL_ASSERT_NOT((
