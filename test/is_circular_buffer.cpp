...
//[test__is_circular_buffer__std_containers
MPL_TEST_CASE()
{
    BOOST_MPL_ASSERT_NOT((
        boost::concept::traits::is_circular_buffer<
            std::vector<int>
        >
    ));
    BOOST_MPL_ASSERT_NOT((
...
//[test__is_circular_buffer__boost_containers
MPL_TEST_CASE()
{
    BOOST_MPL_ASSERT_NOT((
        boost::concept::traits::is_circular_buffer<
...
//[test__is_circular_buffer__ptr_containers
MPL_TEST_CASE()
{
    BOOST_MPL_ASSERT_NOT((
        boost::concept::traits::is_circular_buffer<
...
//[test__is_circular_buffer__multi_index_containers
MPL_TEST_CASE()
{
...
//[test__is_circular_buffer__bimap_views
MPL_TEST_CASE()
{
    BOOST_MPL_ASSERT_NOT((
        boost::concept::traits::is_circular_buffer<
...
//[test__is_circular_buffer__ublas
MPL_TEST_CASE()
{
    BOOST_MPL_ASSERT_NOT((
        boost::concept::traits::is_circular_buffer<
...
//[test__is_circular_buffer__boost_heaps
MPL_TEST_CASE()
{
    BOOST_MPL_ASSERT_NOT((
        boost::concept::traits::is_circular_buffer<
...
//[test__is_circular_buffer__misc_containers
MPL_TEST_CASE()
{
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_circular_buffer<
