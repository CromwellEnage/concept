...
{
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_incidence_graph<
...
{
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_incidence_graph<boost::grid_graph<5> >
    ));
    BOOST_MPL_ASSERT((
        boost::concept::traits::is_incidence_graph<boost::grid_graph<5> const>
    ));
