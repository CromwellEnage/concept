...
#ifndef BOOST_CONCEPT_POLICY_SELECTOR_SIGNATURE_STD_PRIORITY_QUEUE_HPP
#define BOOST_CONCEPT_POLICY_SELECTOR_SIGNATURE_STD_PRIORITY_QUEUE_HPP
...
//[reference__std_priority_queue_selector_signature
namespace boost { namespace concept { namespace policy {

    template <typename Key>
    struct std_priority_queue_selector_signature
    {
