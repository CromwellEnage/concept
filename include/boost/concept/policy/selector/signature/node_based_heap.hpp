...
#ifndef BOOST_CONCEPT_POLICY_SELECTOR_SIGNATURE_NODE_BASED_HEAP_HPP
#define BOOST_CONCEPT_POLICY_SELECTOR_SIGNATURE_NODE_BASED_HEAP_HPP
...
//[reference__node_based_heap_selector_signature
namespace boost { namespace concept { namespace policy {

    template <typename Key>
    struct node_based_heap_selector_signature
    {
