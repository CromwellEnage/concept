...
#ifndef BOOST_CONCEPT_POLICY_SELECTOR_SIGNATURE_BOOST_PRIORITY_QUEUE_HPP
#define BOOST_CONCEPT_POLICY_SELECTOR_SIGNATURE_BOOST_PRIORITY_QUEUE_HPP
...
//[reference__boost_priority_queue_selector_signature
namespace boost { namespace concept { namespace policy {

    template <typename Key>
    struct boost_priority_queue_selector_signature
    {
