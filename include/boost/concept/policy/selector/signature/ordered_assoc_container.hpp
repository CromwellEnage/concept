...
#ifndef BOOST_CONCEPT_POLICY_SELECTOR_SIGNATURE_ORDERED_ASSOC_CONTAINER_HPP
#define BOOST_CONCEPT_POLICY_SELECTOR_SIGNATURE_ORDERED_ASSOC_CONTAINER_HPP
...
//[reference__ordered_associative_container_selector_signature
namespace boost { namespace concept { namespace policy {

    template <typename Key, typename Value>
    struct ordered_associative_container_selector_signature
    {
