...
#ifndef BOOST_CONCEPT_POLICY_SELECTOR_SIGNATURE_D_ARY_HEAP_HPP
#define BOOST_CONCEPT_POLICY_SELECTOR_SIGNATURE_D_ARY_HEAP_HPP
...
//[reference__d_ary_heap_selector_signature
namespace boost { namespace concept { namespace policy {

    template <typename Key>
    struct d_ary_heap_selector_signature
    {
