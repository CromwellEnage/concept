...
#ifndef \
BOOST_CONCEPT_POLICY_SELECTOR_SIGNATURE_UNORDER_ASSOC_PTR_CONTAINER_HPP
#define \
BOOST_CONCEPT_POLICY_SELECTOR_SIGNATURE_UNORDER_ASSOC_PTR_CONTAINER_HPP
...
//[reference__unordered_associative_ptr_container_selector_signature
namespace boost { namespace concept { namespace policy {

    template <typename Key, typename Value>
    struct unordered_associative_ptr_container_selector_signature
    {
