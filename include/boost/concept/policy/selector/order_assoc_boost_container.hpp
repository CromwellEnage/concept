...
#ifndef BOOST_CONCEPT_POLICY_SELECTOR_ORDER_ASSOC_BOOST_CONTAINER_HPP
#define BOOST_CONCEPT_POLICY_SELECTOR_ORDER_ASSOC_BOOST_CONTAINER_HPP
...
//[reference__ordered_associative_boost_container_selector
...
//->
              , ::boost::mpl::apply1<
                    ::boost::concept::policy::boost_set_selector<P0,P1,P2>
                  , Key
                >
              , ::boost::mpl::apply2<
                    ::boost::concept::policy::boost_map_selector<P0,P1,P2>
                  , Key
                  , Mapped
                >
            >
