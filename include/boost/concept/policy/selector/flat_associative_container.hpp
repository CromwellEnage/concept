...
#ifndef BOOST_CONCEPT_POLICY_SELECTOR_FLAT_ASSOCIATIVE_CONTAINER_HPP
#define BOOST_CONCEPT_POLICY_SELECTOR_FLAT_ASSOCIATIVE_CONTAINER_HPP
...
//[reference__flat_associative_container_selector
...
//->
              , ::boost::mpl::apply1<
                    ::boost::concept::policy::flat_set_selector<P0,P1,P2>
                  , Key
                >
              , ::boost::mpl::apply2<
                    ::boost::concept::policy::flat_map_selector<P0,P1,P2>
                  , Key
                  , Mapped
                >
            >
