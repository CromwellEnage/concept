...
#ifndef BOOST_CONCEPT_POLICY_SELECTOR_UNORD_ASSOC_BOOST_CONTAINER_HPP
#define BOOST_CONCEPT_POLICY_SELECTOR_UNORD_ASSOC_BOOST_CONTAINER_HPP
...
//[reference__unordered_associative_boost_container_selector
...
//->
              , ::boost::mpl::apply1<
                    ...
                    ::boost_unordered_set_selector<P0,P1,P2,P3>
                  , Key
                >
              , ::boost::mpl::apply2<
                    ::boost::concept::policy
                    ::boost_unordered_map_selector<P0,P1,P2,P3>
                  , Key
                  , Mapped
                >
            >
