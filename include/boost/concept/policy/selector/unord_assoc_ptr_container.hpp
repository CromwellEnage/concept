...
#ifndef BOOST_CONCEPT_POLICY_SELECTOR_UNORD_ASSOC_PTR_CONTAINER_HPP
#define BOOST_CONCEPT_POLICY_SELECTOR_UNORD_ASSOC_PTR_CONTAINER_HPP
...
//[reference__unordered_associative_ptr_container_selector
...
//->
              , ::boost::mpl::apply1<
                    ...
                    ::ptr_unordered_set_selector<P0,P1,P2,P3,P4>
                  , Key
                >
              , ::boost::mpl::apply2<
                    ::boost::concept::policy
                    ::ptr_unordered_map_selector<P0,P1,P2,P3,P4>
                  , Key
                  , Mapped
                >
            >
