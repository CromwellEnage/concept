...
#ifndef BOOST_CONCEPT_POLICY_SELECTOR_D_ARY_HEAP_HPP
#define BOOST_CONCEPT_POLICY_SELECTOR_D_ARY_HEAP_HPP
...
#include <boost/concept/policy/selector/signature/d_ary_heap.hpp>
#include <boost/heap/d_ary_heap.hpp>
#include <boost/heap/policies.hpp>
#include <boost/parameter/value_type.hpp>
#include <boost/mpl/apply.hpp>

//[reference__d_ary_heap_selector
    ...
    struct d_ary_heap_selector
    {
        ...
        class apply
        {
            typedef typename ::boost::concept::policy
                    ::d_ary_heap_selector_signature<T>::type
                    ::BOOST_NESTED_TEMPLATE bind<P0,P1,P2,P3,P4,P5>::type
                    _arg_pack;
