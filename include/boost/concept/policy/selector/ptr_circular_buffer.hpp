...
#ifndef BOOST_CONCEPT_POLICY_SELECTOR_PTR_CIRCULAR_BUFFER_HPP
#define BOOST_CONCEPT_POLICY_SELECTOR_PTR_CIRCULAR_BUFFER_HPP
...
//[reference__ptr_circular_buffer_selector
namespace boost { namespace concept { namespace policy {
    ...
    struct ptr_circular_buffer_selector
    {
        ...
        class apply
        {
         ...
         public:
            typedef ::boost::ptr_circular_buffer<
                        T
