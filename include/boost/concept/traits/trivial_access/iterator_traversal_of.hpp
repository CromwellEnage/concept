...
#ifndef BOOST_CONCEPT_TRAITS_TRIVIAL_ACCESS_ITERATOR_TRAVERSAL_OF_HPP
#define BOOST_CONCEPT_TRAITS_TRIVIAL_ACCESS_ITERATOR_TRAVERSAL_OF_HPP
...
namespace _detail { namespace metafunction {
    ...
    struct iterator_traversal_of_impl
      : ::boost::mpl::eval_if<
          ...
          , ::boost::iterators::iterator_traversal<
#if defined(BOOST_NO_CXX17_ITERATOR_TRAITS)
                T
#else
...
//[reference__iterator_traversal_of
namespace boost { namespace concept { namespace traits {
...
namespace boost { namespace concept { namespace traits {
    ...
    struct iterator_traversal_of_t
      : ::boost::concept::traits::iterator_traversal_of<T>::type
    {
    };
}}}  // namespace boost::concept::traits
