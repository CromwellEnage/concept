...
#ifndef BOOST_CONCEPT_TRAITS_TRIVIAL_ACCESS_FIRST_ARGUMENT_TYPE_OF_HPP
#define BOOST_CONCEPT_TRAITS_TRIVIAL_ACCESS_FIRST_ARGUMENT_TYPE_OF_HPP

namespace boost { namespace concept { namespace traits {
namespace _detail { namespace metafunction {

    template <typename T>
    struct first_argument_type_of_actual
    {
    ...
    struct first_argument_type_of
      : ::boost::mpl::eval_if<
          ...
          , ::boost::concept::traits::_detail::metafunction
            ::first_argument_type_of_actual<T>
        >
    {
    };
}}  // namespace _detail::metafunction
...
namespace boost { namespace concept { namespace traits {
    ...
    struct first_argument_type_of_t
      : ::boost::concept::traits::first_argument_type_of<T>::type
    {
    };
}}}  // namespace boost::concept::traits
#endif
