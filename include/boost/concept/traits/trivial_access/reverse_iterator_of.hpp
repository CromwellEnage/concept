...
#ifndef BOOST_CONCEPT_TRAITS_TRIVIAL_ACCESS_REVERSE_ITERATOR_OF_HPP
#define BOOST_CONCEPT_TRAITS_TRIVIAL_ACCESS_REVERSE_ITERATOR_OF_HPP

namespace boost { namespace concept { namespace traits {
namespace _detail { namespace metafunction {

    template <typename T>
    struct reverse_iterator_of_impl
    {
      ...
      : ::boost::mpl::eval_if<
          ...
          , ::boost::mpl::eval_if<
              ...
              , ::boost::concept::traits::_detail::metafunction
                ::const_reverse_iterator_of_impl<T>
              , ::boost::concept::traits::_detail::metafunction
                ::reverse_iterator_of_impl<T>
            >
        >
...
namespace boost { namespace concept { namespace traits {
    ...
    struct reverse_iterator_of_t
      : ::boost::concept::traits::reverse_iterator_of<T>::type
    {
    };
}}}  // namespace boost::concept::traits
