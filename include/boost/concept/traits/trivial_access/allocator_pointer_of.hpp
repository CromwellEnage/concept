...
#ifndef BOOST_CONCEPT_TRAITS_TRIVIAL_ACCESS_ALLOCATOR_POINTER_OF_HPP
#define BOOST_CONCEPT_TRAITS_TRIVIAL_ACCESS_ALLOCATOR_POINTER_OF_HPP
...
namespace _detail { namespace metafunction {
    ...
    template <typename T>
    struct allocator_const_pointer_of_impl
      : ::boost::mpl::eval_if<
          ...
          , ::boost::mpl::eval_if<
              ...
              , ::boost::concept::traits::_detail::metafunction
                ::allocator_const_pointer_of_value<T>
            >
        >
    {
    };
...
#endif
          , ::boost::concept::traits::_detail::metafunction
            ::allocator_const_pointer_of_impl<T>
          , ::boost::mpl::eval_if<
...
//[reference__allocator_pointer_of
namespace boost { namespace concept { namespace traits {
...
//<-
      ...
      : ::boost::concept::traits::_detail::metafunction::allocator_pointer_of<
#if defined(BOOST_NO_CXX11_HDR_TYPE_TRAITS)
...
namespace boost { namespace concept { namespace traits {
    ...
    struct allocator_pointer_of_t
      : ::boost::concept::traits::allocator_pointer_of<T>::type
    {
    };
}}}  // namespace boost::concept::traits
