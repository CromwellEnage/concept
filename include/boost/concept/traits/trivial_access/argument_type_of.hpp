...
#ifndef BOOST_CONCEPT_TRAITS_TRIVIAL_ACCESS_ARGUMENT_TYPE_OF_HPP
#define BOOST_CONCEPT_TRAITS_TRIVIAL_ACCESS_ARGUMENT_TYPE_OF_HPP

namespace boost { namespace concept { namespace traits {
namespace _detail { namespace metafunction {

    template <typename T>
    struct argument_type_of_actual
    {
...
//<-
      ...
      : ::boost::concept::traits::_detail::metafunction::argument_type_of<
#if defined(BOOST_NO_CXX11_HDR_TYPE_TRAITS)
...
namespace boost { namespace concept { namespace traits {
    ...
    struct argument_type_of_t
      : ::boost::concept::traits::argument_type_of<T>::type
    {
    };
}}}  // namespace boost::concept::traits
#endif
