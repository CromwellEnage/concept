...
#ifndef BOOST_CONCEPT_TRAITS_TRIVIAL_ACCESS_EDGE_PARALLEL_CATEGORY_OF_HPP
#define BOOST_CONCEPT_TRAITS_TRIVIAL_ACCESS_EDGE_PARALLEL_CATEGORY_OF_HPP
...
namespace _detail { namespace metafunction {
    ...
    template <typename T>
    struct edge_parallel_category_of_impl
    {
#if defined BOOST_NO_CXX11_HDR_TYPE_TRAITS
...
//<-
      ...
      : ::boost::mpl::eval_if<
          ...
          , ::boost::concept::traits::_detail::metafunction
            ::edge_parallel_category_of_impl<T>
        >
...
namespace boost { namespace concept { namespace traits {
    ...
    struct edge_parallel_category_of_t
      : ::boost::concept::traits::edge_parallel_category_of<T>::type
    {
    };
}}}  // namespace boost::concept::traits
