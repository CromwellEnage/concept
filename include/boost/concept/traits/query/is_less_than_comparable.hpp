...
#ifndef BOOST_CONCEPT_TRAITS_QUERY_IS_LESS_THAN_COMPARABLE_HPP
#define BOOST_CONCEPT_TRAITS_QUERY_IS_LESS_THAN_COMPARABLE_HPP
     ...
     public:
        typedef typename ::boost::mpl::if_c<
            sizeof(
                ...
                ::has_less_than_comparable_operator<T,U>
                ::BOOST_NESTED_TEMPLATE _check<T,U>(BOOST_TTI_DETAIL_NULLPTR)
            ) == sizeof(::boost::type_traits::yes_type)
          , ::boost::concept::traits::_detail::metafunction
            ::is_less_than_comparable_impl<T,U>
          , ::boost::mpl::false_
        >::type type;
    };
}}  // namespace _detail::metafunction
...
//<-
      ...
      : ::boost::mpl::eval_if<
            ...
            ::has_less_than_comparable_operator<T,U>::type
          , ::boost::concept::traits::_detail::metafunction
            ::has_less_than_comparable_operator<U,T>
          , ::boost::mpl::false_
        >::type
...
//->
    ...
    template <typename T>
    struct is_less_than_comparable<T,::boost::concept::policy::use_default>
//<-
#if defined(BOOST_CONCEPT_CONFIG_DOCUMENTATION)
//->
      : _mpl_if_<
...
#else
      : ::boost::concept::traits::_detail::metafunction
        ::has_less_than_comparable_operator<T,T>::type
#endif  // BOOST_CONCEPT_CONFIG_DOCUMENTATION
//->
    {
    };
