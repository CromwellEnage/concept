...
#ifndef BOOST_CONCEPT_TRAITS_QUERY_IS_VERTEX_LIST_GRAPH_HPP
#define BOOST_CONCEPT_TRAITS_QUERY_IS_VERTEX_LIST_GRAPH_HPP
...
namespace _detail { namespace metafunction {
    ...
    template <typename T>
    struct has_vertex_list_graph_ops_impl
      : ::boost::mpl::if_<
#if defined BOOST_NO_CXX11_HDR_TYPE_TRAITS
            ::boost::is_same<
#else
            ::std::is_same<
                ...
                decltype
#endif
                (num_vertices(::boost::declval<T const>()))
              , typename ::boost::graph::graph_traits<T>::vertices_size_type
            >
          , ::boost::concept::traits::is_range<
#if defined BOOST_NO_CXX11_DECLTYPE
                BOOST_TYPEOF_KEYWORD(vertices(::boost::declval<T const>()))
#else
                decltype(vertices(::boost::declval<T const>()))
#endif
#if defined BOOST_NO_CXX11_HDR_TYPE_TRAITS
              , ::boost::is_same<
#else
    ...
    template <typename T>
    class has_vertex_list_graph_ops
    {
        template <typename B>
        static ::boost::type_traits::yes_type
            _check_range(
                ...
                typename ::std::add_pointer<
                    ...
                    decltype
#endif
                    (vertices(::boost::declval<B const>()))
                >::type
            );
        ...
        static ::boost::type_traits::yes_type
            _check_count(
                ...
                typename ::std::add_pointer<
                    ...
                    decltype
#endif
                    (num_vertices(::boost::declval<B const>()))
                >::type
            );
     ...
     public:
        typedef typename ::boost::mpl::eval_if_c<
                  ...
                  , ::boost::concept::traits::_detail::metafunction
                    ::has_vertex_list_graph_ops_impl<T>
                  , ::boost::mpl::false_
                >::type
                type;
    };
    ...
    template <typename T>
    class is_vertex_list_graph_impl
    {
#if defined BOOST_NO_CXX11_HDR_TYPE_TRAITS
     ...
     public:
        typedef typename ::boost::mpl::eval_if<
                    ::boost::concept::traits::has_vertex_iterator<
                        ::boost::graph::graph_traits<_mutable_T>
                    >
                  , ::boost::mpl::eval_if<
                        ::boost::concept::traits::has_vertices_size_type<
                            ::boost::graph::graph_traits<_mutable_T>
                        >
                      , ::boost::concept::traits::_detail::metafunction
                        ::has_vertex_list_graph_ops<_mutable_T>
                      , ::boost::mpl::false_
                    >
                  , ::boost::mpl::false_
                >::type
