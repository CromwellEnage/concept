...
#ifndef BOOST_CONCEPT_TRAITS_QUERY_IS_ADAPTABLE_UNARY_FUNC_HPP
#define BOOST_CONCEPT_TRAITS_QUERY_IS_ADAPTABLE_UNARY_FUNC_HPP
...
namespace _detail { namespace metafunction {
    ...
    template <typename T>
    struct is_adaptable_unary_function_impl
      : ::boost::mpl::eval_if<
#if defined(BOOST_NO_CXX11_HDR_TYPE_TRAITS)
            ::boost::is_void<
#else
    ...
    struct is_adaptable_unary_function
      : ::boost::mpl::eval_if<
          ...
          , ::boost::concept::traits::_detail::metafunction
            ::is_adaptable_unary_function_impl<T>
          , ::boost::mpl::false_
        >
    {
    };
...
//->
      : _mpl_eval_if_<
        ...
        , _mpl_eval_if_<
            _bct_has_argument_type_<T>
          , _mpl_eval_if_<
              _bct_is_unary_function_<
                T
              , typename _bct_argument_type_of_<T>::type
              , ResultPlaceholderExpr
              >
            , _mpl_eval_if_<
                _std_is_void_<
              ...
              , _mpl_if_<
                  _std_is_convertible_<
                    _decltype_(
                      _declval_<T>()(
                        _declval_<
                          typename _bct_argument_type_of_<
                            T
                          >::type
                        >()
                      )
...
//<-
      ...
      : ::boost::mpl::eval_if<
          ...
          , ::boost::mpl::eval_if<
                ::boost::concept::traits::has_argument_type<T>
              , ::boost::concept::traits::_detail::metafunction
                ::is_adaptable_unary_function<T,ResultPlaceholderExpr>
              , ::boost::mpl::false_
            >
          , ::boost::mpl::false_
        >::type
