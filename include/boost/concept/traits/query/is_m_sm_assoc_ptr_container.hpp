...
#ifndef BOOST_CONCEPT_TRAITS_QUERY_IS_M_SM_ASSOC_PTR_CONTAINER_HPP
#define BOOST_CONCEPT_TRAITS_QUERY_IS_M_SM_ASSOC_PTR_CONTAINER_HPP
...
namespace _detail { namespace metafunction {
    ...
    template <typename T>
    struct is_multiple_simple_associative_ptr_container_impl
      ...
      : ::boost::mpl::eval_if<
          ...
          , ::boost::mpl::eval_if<
              ...
              , ::boost::mpl::if_<
                  ...
                  , ::boost::mpl::false_
                  , ::boost::concept::traits::_detail::metafunction
                    ::is_multiple_simple_associative_ptr_container_impl<T>
                >
              , ::boost::mpl::false_
            >
          , ::boost::mpl::false_
