...
#ifndef BOOST_CONCEPT_TRAITS_QUERY_IS_BITWISE_OR_ASSIGNABLE_HPP
#define BOOST_CONCEPT_TRAITS_QUERY_IS_BITWISE_OR_ASSIGNABLE_HPP
...
namespace _detail { namespace metafunction {
    ...
    struct is_bitwise_or_assignable_impl
      : ::boost::mpl::apply1<
...
namespace _detail { namespace metafunction {
    ...
    class has_bitwise_or_assign_op
    {
     ...
     public:
        typedef ::boost::mpl::bool_<
            sizeof(
                ::boost::concept::traits::_detail::metafunction
                ::has_bitwise_or_assign_op<T,Operand>::BOOST_NESTED_TEMPLATE
    ...
    template <typename T>
    class has_bitwise_or_assign_op<T,::boost::concept::policy::use_default>
...
//[reference__is_bitwise_or_assignable
namespace boost { namespace concept { namespace traits {
...
//<-
      ...
      : ::boost::mpl::if_<
            ...
            ::has_bitwise_or_assign_op<T,Operand>::type
          , ::boost::concept::traits::_detail::metafunction
            ::is_bitwise_or_assignable_impl<T,Operand,ResultPlaceholderExpr>
          , ::boost::mpl::false_
        >::type
