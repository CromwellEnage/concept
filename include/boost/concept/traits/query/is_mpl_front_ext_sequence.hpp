...
#ifndef BOOST_CONCEPT_TRAITS_QUERY_IS_MPL_FRONT_EXT_SEQUENCE_HPP
#define BOOST_CONCEPT_TRAITS_QUERY_IS_MPL_FRONT_EXT_SEQUENCE_HPP
...
namespace _detail { namespace metafunction {
    ...
    template <typename T>
    struct is_mpl_front_extensible_sequence_impl
    {
    };
...
//<-
      ...
      : ::boost::mpl::eval_if<
          ...
          , ::boost::concept::traits::_detail::metafunction
            ::is_mpl_front_extensible_sequence<T>
          , ::boost::mpl::false_
        >::type
