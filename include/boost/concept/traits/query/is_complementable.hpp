...
#ifndef BOOST_CONCEPT_TRAITS_QUERY_IS_COMPLEMENTABLE_HPP
#define BOOST_CONCEPT_TRAITS_QUERY_IS_COMPLEMENTABLE_HPP
     ...
     public:
        typedef typename ::boost::mpl::if_c<
            sizeof(
                ...
                ::is_complementable<T,ResultPlaceholderExpr>
                ::BOOST_NESTED_TEMPLATE _check<T>(BOOST_TTI_DETAIL_NULLPTR)
            ) == sizeof(::boost::type_traits::yes_type)
          , ::boost::concept::traits::_detail::metafunction
            ::is_complementable_impl<T,ResultPlaceholderExpr>
          , ::boost::mpl::false_
        >::type type;
    };
}}  // namespace _detail::metafunction
...
//<-
      ...
      : ::boost::concept::traits::_detail::metafunction::is_complementable<
#if defined(BOOST_NO_CXX11_HDR_TYPE_TRAITS)
