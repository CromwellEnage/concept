...
//->
      : _mpl_eval_if_<
          _bct_is_bidirectional_iterator_<T>
        , _mpl_eval_if_<
            _bct_is_additive_<
...
#else
      : ::boost::mpl::if_<
            ::boost::concept::traits::is_bidirectional_iterator<T>
...
namespace boost { namespace concept { namespace traits {
    ...
    template <typename T, typename IsStrict>
    struct is_indexable_iterator< ::std::reverse_iterator<T>,IsStrict>
      : ::boost::concept::traits::is_indexable_iterator<T,IsStrict>
    {
    };

    template <typename T, typename IsStrict>
    struct is_indexable_iterator< ::std::reverse_iterator<T> const,IsStrict>
      : ::boost::concept::traits::is_indexable_iterator<T,IsStrict>
    {
    };
...
namespace boost { namespace concept { namespace traits {
    ...
    template <typename T, typename IsStrict>
    struct is_indexable_iterator< ::boost::move_iterator<T>,IsStrict>
      : ::boost::concept::traits::is_indexable_iterator<T,IsStrict>
    {
    };

    template <typename T, typename IsStrict>
    struct is_indexable_iterator< ::boost::move_iterator<T> const,IsStrict>
      : ::boost::concept::traits::is_indexable_iterator<T,IsStrict>
    {
    };
...
namespace boost { namespace concept { namespace traits {
    ...
    struct is_indexable_iterator<
      ...
      , IsStrict
    > : ::boost::concept::traits::is_indexable_iterator<VoidIter,IsStrict>
    {
    };
