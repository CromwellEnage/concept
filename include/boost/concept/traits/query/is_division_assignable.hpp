...
#ifndef BOOST_CONCEPT_TRAITS_QUERY_IS_DIVISION_ASSIGNABLE_HPP
#define BOOST_CONCEPT_TRAITS_QUERY_IS_DIVISION_ASSIGNABLE_HPP
...
namespace _detail { namespace metafunction {
    ...
    class has_divide_assign_op
    {
     ...
     public:
        typedef ::boost::mpl::bool_<
            sizeof(
                ::boost::concept::traits::_detail::metafunction
                ::has_divide_assign_op<T,Divisor>::BOOST_NESTED_TEMPLATE
    ...
    template <typename T>
    class has_divide_assign_op<T,::boost::concept::policy::use_default>
...
//<-
      ...
      : ::boost::mpl::if_<
            ...
            ::has_divide_assign_op<T,Divisor>::type
          , ::boost::concept::traits::_detail::metafunction
