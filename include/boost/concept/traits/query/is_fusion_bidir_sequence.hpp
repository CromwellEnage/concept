...
#ifndef BOOST_CONCEPT_TRAITS_QUERY_IS_FUSION_BIDIR_SEQUENCE_HPP
#define BOOST_CONCEPT_TRAITS_QUERY_IS_FUSION_BIDIR_SEQUENCE_HPP
...
//->
      : _mpl_eval_if_<
          ...
          , _mpl_eval_if_<
              ...
              , _mpl_eval_if_<
                    _mpl_and_<
                        _bct_is_fusion_bidirectional_iterator_<
                            typename _fusion_result_of_end_<T>::type
                        >
                      , _bct_has_type_<
                            _fusion_result_of_prior_<
                                typename _fusion_result_of_end_<T>::type
                            >
                        >
                      , _bct_has_type_<
                  ...
                  , _mpl_and_<
                      ...
                      , _std_is_same_<
                            typename _fusion_result_of_deref_<
                                typename _fusion_result_of_prior_<
...
//<-
      ...
      : ::boost::concept::traits::_detail::metafunction
        ::is_fusion_sequence_empty_or_not<
            T
          , ::boost::fusion::traits::is_bidirectional< ::boost::mpl::_>
