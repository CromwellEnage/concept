...
#ifndef BOOST_CONCEPT_TRAITS_QUERY_IS_COMPARABLE_HPP
#define BOOST_CONCEPT_TRAITS_QUERY_IS_COMPARABLE_HPP
        ...
        typedef typename ::boost::mpl::eval_if_c<
            (
                sizeof(
                    ...
                    ::has_comparable_operators<T,U>::BOOST_NESTED_TEMPLATE
                    _check_le<T,U>(BOOST_TTI_DETAIL_NULLPTR)
                ) == sizeof(::boost::type_traits::yes_type)
            ) && (
                sizeof(
                    ::boost::concept::traits::_detail::metafunction
                    ::has_comparable_operators<T,U>::BOOST_NESTED_TEMPLATE
                    _check_gt<T,U>(BOOST_TTI_DETAIL_NULLPTR)
                ) == sizeof(::boost::type_traits::yes_type)
            ) && (
                sizeof(
                    ::boost::concept::traits::_detail::metafunction
                    ::has_comparable_operators<T,U>::BOOST_NESTED_TEMPLATE
                    _check_ge<T,U>(BOOST_TTI_DETAIL_NULLPTR)
                ) == sizeof(::boost::type_traits::yes_type)
            )
          , ::boost::concept::traits::_detail::metafunction
            ::is_comparable_impl<T,U>
          , ::boost::mpl::false_
        >::type type;
    };
}}  // namespace _detail::metafunction
...
//->
      : _mpl_if_<
            _mpl_and_<
                _bct_is_less_than_comparable_<T,U>
              , _is_valid_expression_(
                    _declval_<T>() > _declval_<U>()
                )
              , _is_valid_expression_(
                    _declval_<T>() <= _declval_<U>()
                )
...
//<-
      ...
      : ::boost::mpl::eval_if<
            typename ::boost::mpl::eval_if<
                ::boost::concept::traits::is_less_than_comparable<T,U>
              , ::boost::concept::traits::_detail::metafunction
                ::has_comparable_operators<T,U>
              , ::boost::mpl::false_
            >::type
          , ::boost::concept::traits::_detail::metafunction
            ::has_comparable_operators<U,T>
          , ::boost::mpl::false_
        >::type
...
//->
    ...
    template <typename T>
    struct is_comparable<T,::boost::concept::policy::use_default>
//<-
#if defined(BOOST_CONCEPT_CONFIG_DOCUMENTATION)
//->
      : _mpl_if_<
...
#else
      : ::boost::mpl::eval_if<
            ::boost::concept::traits::is_less_than_comparable<T>
          , ::boost::concept::traits::_detail::metafunction
            ::has_comparable_operators<T,T>
          , ::boost::mpl::false_
        >::type
#endif  // BOOST_CONCEPT_CONFIG_DOCUMENTATION
//->
