...
#ifndef BOOST_CONCEPT_TRAITS_QUERY_IS_BITWISE_XOR_OPERABLE_HPP
#define BOOST_CONCEPT_TRAITS_QUERY_IS_BITWISE_XOR_OPERABLE_HPP
...
namespace _detail { namespace metafunction {
    ...
    struct is_bitwise_xor_operable_impl
      : ::boost::mpl::apply1<
...
namespace _detail { namespace metafunction {
    ...
    class has_bitwise_xor_operator
    {
     ...
     public:
        typedef ::boost::mpl::bool_<
            sizeof(
                ::boost::concept::traits::_detail::metafunction
                ::has_bitwise_xor_operator<T,Operand>::BOOST_NESTED_TEMPLATE
    ...
    template <typename T>
    class has_bitwise_xor_operator<T,::boost::concept::policy::use_default>
...
//[reference__is_bitwise_xor_operable
namespace boost { namespace concept { namespace traits {
...
//<-
      ...
      : ::boost::mpl::if_<
            ...
            ::has_bitwise_xor_operator<T,Operand>::type
          , ::boost::concept::traits::_detail::metafunction
            ::is_bitwise_xor_operable_impl<T,Operand,ResultPlaceholderExpr>
          , ::boost::mpl::false_
        >::type
