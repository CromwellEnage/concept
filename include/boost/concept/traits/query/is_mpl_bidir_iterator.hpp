...
#ifndef BOOST_CONCEPT_TRAITS_QUERY_IS_MPL_BIDIR_ITERATOR_HPP
#define BOOST_CONCEPT_TRAITS_QUERY_IS_MPL_BIDIR_ITERATOR_HPP
          ...
          , _mpl_if_<
              ...
              , _mpl_less_equal_<
                    typename _mpl_iterator_category_<
                        typename _std_remove_const_<T>::type
                    >::type
                  , _mpl_bidirectional_iterator_tag_
                >
              , _mpl_false_
            >
          , _mpl_false_
...
//<-
      ...
      : ::boost::mpl::eval_if<
          ...
          , ::boost::concept::traits::_detail::metafunction
            ::is_mpl_iterator<T,::boost::mpl::bidirectional_iterator_tag>
          , ::boost::mpl::false_
        >::type
