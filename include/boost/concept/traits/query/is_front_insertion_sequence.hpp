...
#ifndef BOOST_CONCEPT_TRAITS_QUERY_IS_FRONT_INSERTION_SEQUENCE_HPP
#define BOOST_CONCEPT_TRAITS_QUERY_IS_FRONT_INSERTION_SEQUENCE_HPP
...
#include \
<boost/concept/traits/_detail/metafunction/is_front_ins_sequence_impl.hpp>
...
//->
      : _mpl_eval_if_<
            _bct_is_sequence_<T>
          , _mpl_eval_if_<
                _bct_has_front_<typename _std_add_const_<T>::type>
              , _mpl_if_<
                    _bct_has_push_front_<
...
//<-
      ...
      : ::boost::concept::traits::_detail::metafunction
        ::is_minimal_or_mutable_ds<
          ...
          , ::boost::concept::traits::_detail::metafunction
            ::is_front_insertion_sequence_impl<
                ::boost::mpl::_1
              , ::boost::mpl::_2
            >
          , ::boost::concept::traits::_detail::metafunction
