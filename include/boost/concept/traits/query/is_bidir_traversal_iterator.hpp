...
#ifndef BOOST_CONCEPT_TRAITS_QUERY_IS_BIDIRECTIONAL_TRAVERSAL_ITERATOR_HPP
#define BOOST_CONCEPT_TRAITS_QUERY_IS_BIDIRECTIONAL_TRAVERSAL_ITERATOR_HPP

#include <boost/concept/traits/query_fwd.hpp>
#include <boost/concept/traits/query/is_fwd_traversal_iterator.hpp>
#include \
...
//[reference__is_bidirectional_traversal_iterator
...
//->
      : _mpl_eval_if_<
            ...
            >
          , _mpl_eval_if_<
                _bct_is_forward_traversal_iterator_<T>
              , _mpl_if_<
      ...
      : ::boost::mpl::eval_if<
          ...
          , ::boost::mpl::if_<
                ::boost::concept::traits::is_iterator_traversal_of<
                  ...
                  , T
                >
              , ::boost::concept::traits::is_forward_traversal_iterator<T>
              , ::boost::mpl::false_
            >
          , ::boost::mpl::false_
        >::type
