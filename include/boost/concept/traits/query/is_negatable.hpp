...
#ifndef BOOST_CONCEPT_TRAITS_QUERY_IS_NEGATABLE_HPP
#define BOOST_CONCEPT_TRAITS_QUERY_IS_NEGATABLE_HPP
     ...
     public:
        typedef typename ::boost::mpl::if_c<
            sizeof(
                ...
                ::is_negatable<T,ResultPlaceholderExpr>
                ::BOOST_NESTED_TEMPLATE _check<T>(BOOST_TTI_DETAIL_NULLPTR)
            ) == sizeof(::boost::type_traits::yes_type)
          , ::boost::concept::traits::_detail::metafunction
            ::is_negatable_impl<T,ResultPlaceholderExpr>
          , ::boost::mpl::false_
        >::type type;
    };
}}  // namespace _detail::metafunction
...
//<-
      ...
      : ::boost::concept::traits::_detail::metafunction::is_negatable<
#if defined(BOOST_NO_CXX11_HDR_TYPE_TRAITS)
