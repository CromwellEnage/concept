...
#ifndef BOOST_CONCEPT_TRAITS_QUERY_IS_MODULO_ASSIGNABLE_HPP
#define BOOST_CONCEPT_TRAITS_QUERY_IS_MODULO_ASSIGNABLE_HPP
...
namespace _detail { namespace metafunction {
    ...
    struct is_modulo_assignable_impl
      : ::boost::mpl::apply1<
...
namespace _detail { namespace metafunction {
    ...
    class has_modulo_assign_op
    {
     ...
     public:
        typedef ::boost::mpl::bool_<
            sizeof(
                ::boost::concept::traits::_detail::metafunction
                ::has_modulo_assign_op<T,Divisor>::BOOST_NESTED_TEMPLATE
    ...
    template <typename T>
    class has_modulo_assign_op<T,::boost::concept::policy::use_default>
      : public ::boost::concept::traits::_detail::metafunction
        ::has_modulo_assign_op<
            T
#if defined(BOOST_NO_CXX11_HDR_TYPE_TRAITS)
          , typename ::boost::add_const<
                typename ::boost::remove_reference<T>::type
...
//<-
      ...
      : ::boost::mpl::if_<
            ...
            ::has_modulo_assign_op<T,Divisor>::type
          , ::boost::concept::traits::_detail::metafunction
            ::is_modulo_assignable_impl<T,Divisor,ResultPlaceholderExpr>
          , ::boost::mpl::false_
        >::type
