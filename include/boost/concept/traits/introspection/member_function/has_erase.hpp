...
#ifndef BOOST_CONCEPT_TRAITS_INTROSPECTION_MEMBER_FUNCTION_HAS_ERASE_HPP
#define BOOST_CONCEPT_TRAITS_INTROSPECTION_MEMBER_FUNCTION_HAS_ERASE_HPP
...
namespace _detail { namespace metafunction {
    ...
    > : ::boost::mpl::apply1<
          ...
          , decltype
#endif
            (::boost::declref<T>().erase(::boost::declref<Param>()))
        >::type
    {
    };
}}  // namespace _detail::metafunction
     ...
     public:
        typedef typename ::boost::mpl::if_c<
                    sizeof(
                        ...
                        ::has_erase<T,Param1,Param2,ResultPlaceholderExpr>
                        ::_check<T,Param1,Param2>(BOOST_TTI_DETAIL_NULLPTR)
                    ) == sizeof(::boost::type_traits::yes_type)
                  , ::boost::concept::traits::_detail::metafunction
                    ::has_erase_impl<T,Param1,Param2,ResultPlaceholderExpr>
                  , ::boost::mpl::false_
                >::type
                type;
    };
        ...
        static ::boost::type_traits::yes_type
            _check(
                ...
                typename ::std::add_pointer<
                    ...
                    decltype
#endif
                    (::boost::declref<B>().erase(::boost::declref<P>()))
                >::type
            );
      ...
      : _mpl_eval_if_<
            typename _mpl_if_<
              ...
              , _is_valid_expression_(
                    _declref_<T>().erase(_declref_<Param1>())
                )
              , _is_valid_expression_(
                    _declref_<T>().erase(
                        _declref_<Param1>()
...
#else
      : ::boost::concept::traits::_detail::metafunction
        ::has_erase<T,Param1,Param2,ResultPlaceholderExpr>::type
