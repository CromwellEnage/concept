...
#ifndef \
BOOST_CONCEPT_TRAITS_INTROSPECTION_MEMBER_FUNCTION_HAS_BEGIN_BUCKET_HPP
#define \
BOOST_CONCEPT_TRAITS_INTROSPECTION_MEMBER_FUNCTION_HAS_BEGIN_BUCKET_HPP
...
//<-
      ...
      : ::boost::mpl::eval_if<
            ...
            >::type
          , ::boost::concept::traits::_detail::metafunction
            ::has_begin_bucket_impl<T,ResultPlaceholderExpr>
          , ::boost::mpl::false_
        >::type
