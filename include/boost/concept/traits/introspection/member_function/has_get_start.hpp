...
#ifndef BOOST_CONCEPT_TRAITS_INTROSPECTION_MEMBER_FUNCTION_HAS_GET_START_HPP
#define BOOST_CONCEPT_TRAITS_INTROSPECTION_MEMBER_FUNCTION_HAS_GET_START_HPP
...
namespace _detail { namespace metafunction {
    ...
    struct has_get_start_impl
      : ::boost::mpl::apply1<
          ...
          , decltype
#endif
            (::boost::declref<T>().get_start(::boost::declval<Param>()))
        >
    {
    };
        ...
        static ::boost::type_traits::yes_type
            _check(
                ...
                typename ::std::add_pointer<
                    ...
                    decltype
#endif
                    (::boost::declref<B>().get_start(::boost::declval<P>()))
                >::type
            );
...
namespace _detail { namespace metafunction {
    ...
    struct has_get_start
      : ::boost::mpl::eval_if<
            ...
            ::has_get_start_expr<T,Param>::type
          , ::boost::concept::traits::_detail::metafunction
            ::has_get_start_impl<T,ResultPlaceholderExpr,Param>
          , ::boost::mpl::false_
        >
    {
    };
...
#else
      : ::boost::concept::traits::_detail::metafunction
        ::has_get_start<T,Param,ResultPlaceholderExpr>::type
