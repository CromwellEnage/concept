...
#ifndef \
BOOST_CONCEPT_TRAITS_INTROSPECTION_MEMBER_FUNCTION_HAS_INSERT_ELEMENT_HPP
#define \
BOOST_CONCEPT_TRAITS_INTROSPECTION_MEMBER_FUNCTION_HAS_INSERT_ELEMENT_HPP
...
#endif
                    (
                        ::boost::declref<B>().insert_element(
                            ::boost::declval<
#if defined BOOST_NO_CXX11_HDR_TYPE_TRAITS
     ...
     public:
        typedef ::boost::mpl::bool_<
                    sizeof(
                        ...
                        ::has_insert_element_impl<T,Element,1>
                        ::_check<T,Element>(BOOST_TTI_DETAIL_NULLPTR)
    ...
    class has_insert_element_impl<T,Element,2>
    {
     ...
     public:
        typedef ::boost::mpl::bool_<
                    sizeof(
                        ::boost::concept::traits::_detail::metafunction
                        ::has_insert_element_impl<T,Element,2>
                        ::_check<T,Element>(BOOST_TTI_DETAIL_NULLPTR)
                    ) == sizeof(::boost::type_traits::yes_type)
                >
                type;
    ...
    class has_insert_element_with_value_type<T,1>
    {
     ...
     public:
        typedef ::boost::mpl::bool_<
                    sizeof(
                        ::boost::concept::traits::_detail::metafunction
                        ::has_insert_element_with_value_type<T,1>
    ...
    class has_insert_element_with_value_type<T,2>
    {
     ...
     public:
        typedef ::boost::mpl::bool_<
                    sizeof(
                        ::boost::concept::traits::_detail::metafunction
                        ::has_insert_element_with_value_type<T,2>
                        ::_check<T>(BOOST_TTI_DETAIL_NULLPTR)
                    ) == sizeof(::boost::type_traits::yes_type)
                >
                type;
...
namespace _detail { namespace metafunction {
    ...
    struct has_insert_element
      : ::boost::concept::traits::_detail::metafunction
        ::has_insert_element_impl<T,Element,SizeArity::value>
    {
    };
...
//->
      : _mpl_eval_if_<
          ...
          , _mpl_eval_if_<
                _std_is_same_<Element,boost::concept::policy::use_default>
              , _mpl_if_<
                    _bct_has_value_type_<T>
                  , _is_valid_expression_(
                        _declref_<T>().insert_element(
                            _declval_<
...
//<-
      ...
      : ::boost::mpl::eval_if<
          ...
          , ::boost::concept::traits::_detail::metafunction
            ::has_insert_element<T,Element,SizeArity>
          , ::boost::mpl::false_
        >::type
