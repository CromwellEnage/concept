...
#ifndef BOOST_CONCEPT_TRAITS_INTROSPECTION_MEMBER_FUNCTION_HAS_UPPER_BOUND_HPP
#define BOOST_CONCEPT_TRAITS_INTROSPECTION_MEMBER_FUNCTION_HAS_UPPER_BOUND_HPP
...
namespace _detail { namespace metafunction {
    ...
    struct has_upper_bound_impl
      : ::boost::mpl::apply1<
          ...
          , decltype
#endif
            (::boost::declref<T>().upper_bound(::boost::declval<Param>()))
        >
    {
    };
...
namespace _detail { namespace metafunction {
    ...
    struct has_upper_bound
      : ::boost::mpl::eval_if<
            ...
            ::has_upper_bound_expr<T,Param>::type
          , ::boost::concept::traits::_detail::metafunction
            ::has_upper_bound_impl<T,Param,ResultPlaceholderExpr>
          , ::boost::mpl::false_
        >
    {
    };
    ...
    template <typename T, typename ResultPlaceholderExpr>
    struct has_upper_bound_default
      : ::boost::mpl::eval_if<
            typename ::boost::concept::traits::_detail::metafunction
            ::has_upper_bound_expr<
                T
#if defined BOOST_NO_CXX11_HDR_TYPE_TRAITS
              , typename ::boost::remove_const<T>::type::key_type
#else
...
namespace _detail { namespace metafunction {
    ...
    > : ::boost::mpl::eval_if<
          ...
          , ::boost::concept::traits::_detail::metafunction
            ::has_upper_bound_default<T,ResultPlaceholderExpr>
          , ::boost::mpl::false_
        >
    {
    };
...
#else
      : ::boost::concept::traits::_detail::metafunction
        ::has_upper_bound<T,Param,ResultPlaceholderExpr>::type
