...
#ifndef BOOST_CONCEPT_TRAITS_INTROSPECTION_MEMBER_FUNCTION_HAS_PUSH_BACK_HPP
#define BOOST_CONCEPT_TRAITS_INTROSPECTION_MEMBER_FUNCTION_HAS_PUSH_BACK_HPP
...
namespace _detail { namespace metafunction {
    ...
    template <typename T>
    struct has_ptr_push_back
      : ::boost::mpl::eval_if<
            ::boost::concept::traits::has_push_back<
#if defined BOOST_NO_CXX11_DECLTYPE
                BOOST_TYPEOF_KEYWORD(
                    ::boost::declref<
#if defined BOOST_NO_CXX11_HDR_TYPE_TRAITS
...
//<-
      ...
      : ::boost::mpl::eval_if<
            ::boost::concept::traits::has_back<T>
          , ::boost::mpl::eval_if<
                ::boost::concept::traits::_detail::metafunction
