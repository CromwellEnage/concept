...
#ifndef BOOST_CONCEPT_TRAITS_INTROSPECTION_MEMBER_FUNCTION_HAS_FIND_HPP
#define BOOST_CONCEPT_TRAITS_INTROSPECTION_MEMBER_FUNCTION_HAS_FIND_HPP
...
namespace _detail { namespace metafunction {
    ...
    struct has_find_impl
      : ::boost::mpl::apply1<
          ...
          , decltype
#endif
            (::boost::declref<T>().find(::boost::declval<Param>()))
        >
    {
    };
        ...
        static ::boost::type_traits::yes_type
            _check(
                ...
                typename ::std::add_pointer<
                    ...
                    decltype
#endif
                    (::boost::declref<B>().find(::boost::declval<P>()))
                >::type
            );
...
namespace _detail { namespace metafunction {
    ...
    struct has_find
      : ::boost::mpl::eval_if<
            ...
            ::has_find_expr<T,Param>::type
          , ::boost::concept::traits::_detail::metafunction
            ::has_find_impl<T,Param,ResultPlaceholderExpr>
          , ::boost::mpl::false_
        >
    {
    };
...
#endif
            >::type
          , ::boost::concept::traits::_detail::metafunction::has_find_impl<
                T
              , ::boost::concept::policy::use_default
              , ResultPlaceholderExpr
            >
          ...
          , _mpl_eval_if_<
              ...
              , _mpl_eval_if_<
                  ...
                  , _mpl_apply1_<
                        ResultPlaceholderExpr
                      , _decltype_(
                            _declref_<T>().find(_declval_<Param>())
                        )
                    >
                  , _mpl_false_
                >
...
#else
      : ::boost::concept::traits::_detail::metafunction
        ::has_find<T,Param,ResultPlaceholderExpr>::type
