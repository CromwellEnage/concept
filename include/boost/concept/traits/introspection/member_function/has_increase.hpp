...
#ifndef BOOST_CONCEPT_TRAITS_INTROSPECTION_MEMBER_FUNCTION_HAS_INCREASE_HPP
#define BOOST_CONCEPT_TRAITS_INTROSPECTION_MEMBER_FUNCTION_HAS_INCREASE_HPP
...
namespace _detail { namespace metafunction {
    ...
    class has_increase<T,Param,::boost::concept::policy::use_default>
    {
        ...
        static ::boost::type_traits::yes_type
            _check(
                ...
                typename ::std::add_pointer<
                    ...
                    decltype
#endif
                    (::boost::declref<B>().increase(::boost::declref<P>()))
                >::type
            );
...
//->
      : _mpl_if_<
          ...
          , _is_valid_expression_(
                _declref_<T>().increase(_declref_<Param1>())
            )
          , _is_valid_expression_(
                _declref_<T>().increase(
                    _declref_<Param1>()
                  , _declref_<Param2>()
                )
            )
...
//<-
#else
      : ::boost::concept::traits::_detail::metafunction::has_increase<
            T
          , Param1
          , Param2
        >::type
