...
#ifndef BOOST_CONCEPT_TRAITS_INTROSPECTION_MEMBER_FUNCTION_HAS_PLUS_ASSIGN_HPP
#define BOOST_CONCEPT_TRAITS_INTROSPECTION_MEMBER_FUNCTION_HAS_PLUS_ASSIGN_HPP
    ...
    struct has_plus_assign_impl
      : ::boost::mpl::apply1<
          ...
          , BOOST_TYPEOF_KEYWORD(
                ::boost::concept::traits::declref<T>().plus_assign(
...
namespace _detail { namespace metafunction {
    ...
    struct has_plus_assign_impl<
      ...
      , ResultPlaceholderExpr
    > : ::boost::concept::traits::_detail::metafunction::has_plus_assign_impl<
            T
#if defined(BOOST_NO_CXX11_HDR_TYPE_TRAITS)
...
namespace _detail { namespace metafunction {
...
#if defined(BOOST_NO_CXX11_DECLTYPE)
                    BOOST_TYPEOF_KEYWORD(
                        ::boost::concept::traits::declref<B>().plus_assign(
                            ::boost::declval<D>()
                        )
                    )
#else
     ...
     public:
        typedef ::boost::mpl::bool_<
            sizeof(
                ...
                ::has_plus_asgn<T,Addend>::BOOST_NESTED_TEMPLATE
    ...
    template <typename T>
    class has_plus_asgn<T,::boost::concept::policy::use_default>
      : public ::boost::concept::traits::_detail::metafunction::has_plus_asgn<
            T
#if defined(BOOST_NO_CXX11_HDR_TYPE_TRAITS)
          , typename ::boost::add_const<
                typename ::boost::remove_reference<T>::type
