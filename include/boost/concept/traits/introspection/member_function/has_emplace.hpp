...
#ifndef BOOST_CONCEPT_TRAITS_INTROSPECTION_MEMBER_FUNCTION_HAS_EMPLACE_HPP
#define BOOST_CONCEPT_TRAITS_INTROSPECTION_MEMBER_FUNCTION_HAS_EMPLACE_HPP
...
#if defined BOOST_NO_CXX11_DECLTYPE
#if defined BOOST_NO_CXX11_HDR_TYPE_TRAITS
#define BOOST_CONCEPT_TRAITS_INTROSPECTION_MEMBER_FUNC_HAS_EMPLACE_SEQ(ns) \
        (ns)(has_emplace)(::boost::declref<B>().emplace) \
...
namespace _detail { namespace metafunction {
    ...
    BOOST_CONCEPT_TRAITS__DETAIL_HAS_FUNCTION_DEF(
      ...
      , BOOST_CONCEPT_TRAITS_INTROSPECTION_MEMBER_FUNC_HAS_EMPLACE_SEQ(
...
#if defined BOOST_NO_CXX11_VARIADIC_TEMPLATES
#undef BOOST_CONCEPT_TRAITS_INTROSPECTION_MEMBER_FUNC_HAS_EMPLACE_SEQ
#endif
...
//<-
      ...
      : ::boost::concept::traits::_detail::metafunction::has_emplace<
            T
            BOOST_PP_ENUM_TRAILING_PARAMS(
                BOOST_CONCEPT_TRAITS_VARIADIC_ARG_COUNT
              , P
