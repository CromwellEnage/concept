...
#ifndef BOOST_CONCEPT_TRAITS_INTROSPECTION_MEMBER_FUNCTION_HAS_RESET_HPP
#define BOOST_CONCEPT_TRAITS_INTROSPECTION_MEMBER_FUNCTION_HAS_RESET_HPP
...
#if defined(BOOST_NO_CXX11_DECLTYPE)
#if defined(BOOST_NO_CXX11_HDR_TYPE_TRAITS)
#define BOOST_CONCEPT_TRAITS_INTROSPECTION_MEMBER_FUNCTION_HAS_RESET_SEQ(ns) \
    (ns)(has_reset)(::boost::concept::traits::declref<B>().reset) \
...
namespace _detail { namespace metafunction {
    ...
    BOOST_CONCEPT_TRAITS__DETAIL_HAS_FUNCTION_DEF(
      ...
      , BOOST_CONCEPT_TRAITS_INTROSPECTION_MEMBER_FUNCTION_HAS_RESET_SEQ(
    ...
    class has_reset
    {
     ...
     public:
        typedef ::boost::mpl::bool_<
            sizeof(
                ::boost::concept::traits::_detail::metafunction
                ::has_reset<T,Args...>::BOOST_NESTED_TEMPLATE
...
#if defined(BOOST_NO_CXX11_VARIADIC_TEMPLATES)
#undef BOOST_CONCEPT_TRAITS_INTROSPECTION_MEMBER_FUNCTION_HAS_RESET_SEQ
#endif
...
//->
      : _is_valid_expression_(
            _bct_declref_<T>.reset(
                _forward_<Args>(_declval_<Args>())...
            )
        )
//<-
#elif defined(BOOST_NO_CXX11_VARIADIC_TEMPLATES)
      : ::boost::concept::traits::_detail::metafunction::has_reset<
            T
            BOOST_PP_ENUM_TRAILING_PARAMS(
                BOOST_CONCEPT_TRAITS_VARIADIC_ARG_COUNT
              , P
