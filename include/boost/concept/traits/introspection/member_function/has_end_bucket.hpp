...
#ifndef BOOST_CONCEPT_TRAITS_INTROSPECTION_MEMBER_FUNCTION_HAS_END_BUCKET_HPP
#define BOOST_CONCEPT_TRAITS_INTROSPECTION_MEMBER_FUNCTION_HAS_END_BUCKET_HPP
     ...
     public:
        typedef ::boost::mpl::bool_<
                    sizeof(
                        ...
                        ::has_end_bucket<T>::_chk<T>(BOOST_TTI_DETAIL_NULLPTR)
...
//<-
      ...
      : ::boost::mpl::eval_if<
            ...
            >::type
          , ::boost::concept::traits::_detail::metafunction
            ::has_end_bucket_impl<T,ResultPlaceholderExpr>
          , ::boost::mpl::false_
        >::type
