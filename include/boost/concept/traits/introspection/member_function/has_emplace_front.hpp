...
#ifndef \
BOOST_CONCEPT_TRAITS_INTROSPECTION_MEMBER_FUNCTION_HAS_EMPLACE_FRONT_HPP
#define \
BOOST_CONCEPT_TRAITS_INTROSPECTION_MEMBER_FUNCTION_HAS_EMPLACE_FRONT_HPP
...
#if defined BOOST_NO_CXX11_DECLTYPE
#if defined BOOST_NO_CXX11_HDR_TYPE_TRAITS
#define BOOST_CONCEPT_TRAITS_INTROSPECTION_MEM_FUNC_HAS_EMPLACE_FT_SEQ(ns) \
        (ns)(has_emplace_front)(::boost::declref<B>().emplace_front) \
...
namespace _detail { namespace metafunction {
    ...
    BOOST_CONCEPT_TRAITS__DETAIL_HAS_FUNCTION_DEF(
      ...
      , BOOST_CONCEPT_TRAITS_INTROSPECTION_MEM_FUNC_HAS_EMPLACE_FT_SEQ(
...
#if defined BOOST_NO_CXX11_VARIADIC_TEMPLATES
#undef BOOST_CONCEPT_TRAITS_INTROSPECTION_MEM_FUNC_HAS_EMPLACE_FT_SEQ
#endif
...
//->
      : _is_valid_expression_(
            _declref_<T>.emplace_front(
                _forward_<Args>(_declval_<Args>())...
            )
        )
//<-
#elif defined BOOST_NO_CXX11_VARIADIC_TEMPLATES
      : ::boost::concept::traits::_detail::metafunction::has_emplace_front<
            T
            BOOST_PP_ENUM_TRAILING_PARAMS(
                BOOST_CONCEPT_TRAITS_VARIADIC_ARG_COUNT
              , P
