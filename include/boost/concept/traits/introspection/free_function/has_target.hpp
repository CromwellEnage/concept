...
#ifndef BOOST_CONCEPT_TRAITS_INTROSPECTION_FREE_FUNCTION_HAS_TARGET_HPP
#define BOOST_CONCEPT_TRAITS_INTROSPECTION_FREE_FUNCTION_HAS_TARGET_HPP
...
namespace _detail { namespace metafunction {
    ...
    struct has_target_impl
      : ::boost::mpl::apply1<
          ...
          , decltype
#endif
            ((target(::boost::declval<Param>(), ::boost::declval<T>())))
        >::type
    {
    };
...
namespace _detail { namespace metafunction {
    ...
    struct has_target_impl_default
#if defined BOOST_NO_CXX11_HDR_TYPE_TRAITS
      : ::boost::is_same<
#else
      : ::boost::mpl::if_<
...
namespace _detail { namespace metafunction {
    ...
    template <typename T, typename Param>
    struct has_target_impl<T,Param,::boost::concept::policy::use_default>
      : ::boost::mpl::if_<
          ...
          , ::boost::concept::traits::_detail::metafunction
            ::has_target_impl_default<T,Param>
          , ::boost::mpl::false_
        >
    {
    };
...
namespace _detail { namespace metafunction {
    ...
    class has_target
    {
        ...
        static ::boost::type_traits::yes_type
            _check(
                ...
                typename ::std::add_pointer<
                    ...
                    decltype
#endif
                    ((target(::boost::declval<P>(), ::boost::declval<B>())))
                >::type
            );
     ...
     public:
        typedef typename ::boost::mpl::if_c<
                    sizeof(
                        ::boost::concept::traits::_detail::metafunction
                        ::has_target<T,Param,ResultPlaceholderExpr>
                        ::_check<T,Param>(BOOST_TTI_DETAIL_NULLPTR)
                    ) == sizeof(::boost::type_traits::yes_type)
                  , ::boost::concept::traits::_detail::metafunction
                    ::has_target_impl<T,Param,ResultPlaceholderExpr>
                  , ::boost::mpl::false_
                >::type
                type;
    };
    ...
    struct has_target_default
      : ::boost::concept::traits::_detail::metafunction::has_target<
            T
          , typename ::boost::graph_traits<
#if defined BOOST_NO_CXX11_HDR_TYPE_TRAITS
                typename ::boost::remove_const<T>::type
...
namespace _detail { namespace metafunction {
    ...
    > : public ::boost::mpl::if_<
            ...
            >
          , ::boost::concept::traits::_detail::metafunction
            ::has_target_default<T,ResultPlaceholderExpr>
          , ::boost::mpl::false_
        >::type
    {
    };
...
#else
      : ::boost::concept::traits::_detail::metafunction
        ::has_target<T,Param,ResultPlaceholderExpr>::type
