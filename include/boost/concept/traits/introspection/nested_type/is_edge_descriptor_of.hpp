...
#ifndef \
BOOST_CONCEPT_TRAITS_INTROSPECTION_NESTED_TYPE_IS_EDGE_DESCRIPTOR_OF_HPP
#define \
BOOST_CONCEPT_TRAITS_INTROSPECTION_NESTED_TYPE_IS_EDGE_DESCRIPTOR_OF_HPP
...
namespace _detail { namespace metafunction {
    ...
    struct is_edge_descriptor_of_impl
#if defined BOOST_NO_CXX11_HDR_TYPE_TRAITS
      : ::boost::is_same<
#else
      : ::boost::mpl::if_<
            ::std::is_same<
#endif
                typename ::boost::concept::traits::edge_descriptor_of<
...
//[reference__is_edge_descriptor_of
namespace boost { namespace concept { namespace traits {
...
//->
      : _mpl_eval_if_<
          ...
          , _mpl_if_<
                _std_is_same_<
                    typename _bct_edge_descriptor_of_<T2>::type
                  , T1
                >
              , _mpl_true_
              , _mpl_false_
...
//<-
      ...
      : ::boost::mpl::if_<
          ...
          , ::boost::concept::traits::_detail::metafunction
            ::is_edge_descriptor_of_impl<T1,T2>
          , ::boost::mpl::false_
        >::type
