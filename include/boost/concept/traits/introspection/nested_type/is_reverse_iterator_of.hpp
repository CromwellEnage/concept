...
#ifndef \
BOOST_CONCEPT_TRAITS_INTROSPECTION_NESTED_TYPE_IS_REVERSE_ITERATOR_OF_HPP
#define \
BOOST_CONCEPT_TRAITS_INTROSPECTION_NESTED_TYPE_IS_REVERSE_ITERATOR_OF_HPP
...
//->
      : _mpl_eval_if_<
            _bct_has_reverse_iterator_<T2>
          , _mpl_if_<
                _std_is_same_<
                    typename _bct_reverse_iterator_of_<
                        T2
                    >::type
                  , T1
                >
...
//<-
      ...
      : ::boost::mpl::if_<
            ::boost::concept::traits::has_reverse_iterator<T2>
          , ::boost::concept::traits::_detail::metafunction
            ::is_reverse_iterator_of_impl<T1,T2>
          , ::boost::mpl::false_
        >::type
