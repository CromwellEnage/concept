...
#ifndef BOOST_CONCEPT_TRAITS_INTROSPECTION_NESTED_TYPE_IS_TAG_OF_HPP
#define BOOST_CONCEPT_TRAITS_INTROSPECTION_NESTED_TYPE_IS_TAG_OF_HPP
...
namespace _detail { namespace metafunction {
    ...
    struct is_tag_of
      ...
      : ::boost::mpl::if_<
            ::std::is_same<
#endif
                typename ::boost::concept::traits::tag_of<T2>::type
#if defined(BOOST_NO_CXX11_HDR_TYPE_TRAITS)
...
#else
      : ::boost::mpl::if_<
            ::boost::concept::traits::has_tag<T2>
          , ::boost::concept::traits::_detail::metafunction::is_tag_of<T1,T2>
          , ::boost::mpl::false_
        >::type
