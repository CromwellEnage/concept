...
#ifndef \
BOOST_CONCEPT_TRAITS_INTROSPECTION_NESTED_TYPE_IS_REVERSE_ITERATOR1_OF_HPP
#define \
BOOST_CONCEPT_TRAITS_INTROSPECTION_NESTED_TYPE_IS_REVERSE_ITERATOR1_OF_HPP
...
namespace _detail { namespace metafunction {
    ...
    struct is_reverse_iterator1_of_impl
#if defined BOOST_NO_CXX11_HDR_TYPE_TRAITS
      : ::boost::is_same<
#else
      : ::boost::mpl::if_<
...
//->
      : _mpl_eval_if_<
            _bct_has_reverse_iterator1_<T2>
          , _mpl_if_<
                _std_is_same_<
                    typename _bct_reverse_iterator1_of_<T2>::type
                  , T1
                >
              , _mpl_true_
              , _mpl_false_
...
#else
      : ::boost::mpl::if_<
            ::boost::concept::traits::has_reverse_iterator1<T2>
          , ::boost::concept::traits::_detail::metafunction
            ::is_reverse_iterator1_of_impl<T1,T2>
          , ::boost::mpl::false_
        >::type
