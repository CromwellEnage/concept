...
#ifndef \
BOOST_CONCEPT_TRAITS_INTROSPECTION_NESTED_TYPE_IS_ITERATOR_TRAVERSAL_OF_HPP
#define \
BOOST_CONCEPT_TRAITS_INTROSPECTION_NESTED_TYPE_IS_ITERATOR_TRAVERSAL_OF_HPP

#include <boost/concept/traits/trivial_access/iterator_traversal_of.hpp>
...
namespace _detail { namespace metafunction {
    ...
    struct is_iterator_with_traversal
#if defined(BOOST_NO_CXX11_HDR_TYPE_TRAITS)
      ...
      : _mpl_eval_if_<
          ...
          , _mpl_if_<
                _std_is_convertible_<
                    typename _bct_iterator_traversal_of_<T2>::type
...
//<-
      ...
      : ::boost::mpl::if_<
          ...
          , ::boost::concept::traits::_detail::metafunction
            ::is_iterator_with_traversal<T2,T1>
          , ::boost::mpl::false_
        >::type
