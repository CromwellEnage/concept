...
#ifndef \
BOOST_CONCEPT_TRAITS_INTROSPECTION_NESTED_TYPE_IS_EXPRESSION_TYPE_OF_HPP
#define \
BOOST_CONCEPT_TRAITS_INTROSPECTION_NESTED_TYPE_IS_EXPRESSION_TYPE_OF_HPP
...
namespace _detail { namespace metafunction {
    ...
    struct is_expression_type_of_impl
      ...
      : ::boost::is_same<
          ...
          , typename ::boost::remove_const<T2>::type::expression_type
        >
#else
      : ::boost::mpl::if_<
            ::std::is_same<
                typename ::std::remove_const<T1>::type
              , typename ::std::remove_const<T2>::type::expression_type
            >
          , ::boost::mpl::true_
          , ::boost::mpl::false_
        >::type
...
//->
      : _mpl_if_<
            _bct_has_expression_type_<T2>
          , _std_is_same_<
                typename _std_remove_const_<T1>::type
              , typename _std_remove_const_<T2>::type::expression_type
            >
          , _mpl_false_
        >::type
//<-
#else
      : ::boost::mpl::if_<
            ::boost::concept::traits::has_expression_type<T2>
          , ::boost::concept::traits::_detail::metafunction
            ::is_expression_type_of_impl<T1,T2>
          , ::boost::mpl::false_
        >::type
